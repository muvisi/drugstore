...
export class InpatientComponent implements OnInit {
  ...
  searchingPending(text){
    this.service.cashierClaimCheckingSearch(text,'inpatient').subscribe((res)=>{
  ...
  getClaims(){
    this.service.getCashierClaimChecking('inpatient').subscribe((res)=>{
      this.dataSource = new MatTableDataSource(res.results);
    })
  }
  returnedClaims(){
    this.service.getCahierClaimStatus('RETURNED','inpatient').subscribe((res)=>{
      this.returned = new MatTableDataSource(res.results);
    })
  }
  completedClaims(){
    this.service.getCashierCompleted('inpatient').subscribe((res)=>{

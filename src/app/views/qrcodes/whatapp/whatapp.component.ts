...
@Component({
  selector: 'app-whatapp',
  templateUrl: './whatapp.component.html',
  styleUrls: ['./whatapp.component.scss']
})
export class WhatappComponent implements OnInit {
 ...
 ngOnInit() {
   ...
   let qrcode = new QrCodeWithLogo({
    ...
    content: "https://wa.me/14155238886/?text=join nervous-fast",    width: 380,
    nodeQrCodeOptions:{
      color:{
          dark:"#4dbd74",
       //  dark:"#CD0002",#4dbd74
...
//      content: "https://wa.me/14155238886/?text=join nervous-fast",
//      width: 380,
//      nodeQrCodeOptions:{
//        color:{
//          dark:"#CD0002",
